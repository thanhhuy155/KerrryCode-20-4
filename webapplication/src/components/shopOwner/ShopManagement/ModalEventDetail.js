...
export default class ModalEventDetail extends Component {
    render() {
        ...
        if (this.props.SentEvent) {
            var { title, allDay, start, end, images, totalFavorite, status, createdDate, decription } = this.props.SentEvent
        ...
        return (
            <Modal show={this.props.isOpen}>
                ...
                <Modal.Footer>
                    ...
                    <button style ={{display: CheckDate ===-1? 'none':''}}type="button" class="btn btn-danger">Delete this event</button>
