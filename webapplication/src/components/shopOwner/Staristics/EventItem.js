...
export default class EventItem extends Component {
    ...
    render() {
        const {Promotion_Title, Promotion_DateStart,Promotion_DateEnd, Promotion_Status, Promotion_Created, Promotion_TotalFavorite, Promotion_Image, Promotion_Description } = this.props.dataEvent
        var objectModal = {
